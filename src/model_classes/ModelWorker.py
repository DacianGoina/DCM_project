...
from ModelManager import reverse_classifier_to_extractor_str
from ModelManager import get_classifier_to_extractor_str
...
if __name__ == "__main__":
    print("Model Worker")
    worker_execute("In the 1800 Napoleon with his army cross the Alps to invade Italy. After his military success in Italy he continued to Austria.")
